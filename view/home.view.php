<?php require views_path('partials/header');?>
	...
	<div class="d-flex">
		...
		<div class="col-5 bg-light p-4 pt-2">
			...
			<div class="js-gtotal alert alert-danger" style="font-size:15px">Total: $0.00</div>
			<div class="">
				<button onclick="show_modal('amount-paid')" class="btn btn-success my-2 w-100 py-2">Checkout</button>
				<button onclick="clear_all()" class="btn btn-primary my-0 w-100 py-1">Clear All</button>
			</div>
		</div>
	</div>	
